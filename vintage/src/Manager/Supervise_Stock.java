...
public class Supervise_Stock extends JFrame implements MouseListener,ActionListener{
	Image img = null;
    ...
    int count = 0;
    public Supervise_Stock(Manager m1){
    	super("STAFF Supervise Stock");
		...
		button2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				Distroy_Stock d1 = new Distroy_Stock();
			}
		});;
		...
		button3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				Supervise_Stock s2 = new Supervise_Stock(m1);
				dispose();
			}
		});;
